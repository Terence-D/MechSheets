...
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.centerTorso;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.head;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.leftArm;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.leftLeg;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.leftTorso;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.rightArm;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.rightLeg;
import static ca.coffeeshopstudio.meksheets.data.legacy.Locations.rightTorso;
